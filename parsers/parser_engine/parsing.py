...
from parsers.parser_engine.cyberleninka import cyberleninka
from parsers.parser_engine.scholar import scholar
from parsers.parser_engine.socionet import socionet
